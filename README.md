...
## License
This software is built in part using Booleano by Gustavo Narea licensed under the MIT License, a copy of which is in the file LICENSE. [Booleano on launchpad](https://launchpad.net/booleano).
